...
from .views import AdminLoginView, AdminDashboardView, CampanaCreateView, CampanaUpdateView, CampanaDeleteView, CampanaResultadosView, CampanaVotacionView, CampanaQRView, EmitirVotoView, SystemLogsView

urlpatterns = [
    path('admin-login/', AdminLoginView.as_view(), name='admin_login'),
    path('admin-logout/', LogoutView.as_view(), name='admin_logout'),
    path('admin-dashboard/', AdminDashboardView.as_view(), name='admin_dashboard'),
    path('admin-dashboard/logs/', SystemLogsView.as_view(), name='system_logs'),
